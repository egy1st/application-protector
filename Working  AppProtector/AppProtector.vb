...
Namespace DynamicComponents
    Public Class AppProtector
        ...
        Public Sub ShowAuthor()
            ...
            _ProductId = "AppProtector"
            _ProductVersion = "V. 3.5"

            _CompanyInfo = "Application Protector V. 3.5" + vbCrLf
            ...
            MyProtection.SetProductKeys(_CompanyId, _ProductId, _ProductVersion)
            MyProtection.SetAlgorithms(1971, 11, 35)
            MyProtection.SetInformation(_buynow_URL, _CompanyInfo)
            MyProtection.SetLicense(30)
            MyProtection.setRegistrationKey(Internal_Registration_Key)
            MyProtection.ShowAuthor()
            If MyProtection.NotLicensed = True Then
                Application.Exit()
                Exit Sub
            End If
