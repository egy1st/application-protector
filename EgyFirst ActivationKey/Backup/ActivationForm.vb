...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ActivationForm))
        ...
        Me.Algorithms1_Text.ReadOnly = False
        ...
        Me.ProductName.Items.AddRange(New Object() {"Data Manger", "Dynamic Report", "Application Protector", "Num 2 Text", "Binding Recordset", "Data Entry Validator", "Image Button", "Help Authority", "Form Flipper", "Form Translator", "Return Key Enable", "Google Instant Listing", "Top Paying Keywords"})
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.ProductName, Me.KeyList, Me.GroupBox1, Me.Label4, Me.Algorithms3_Text, Me.Label3, Me.Algorithms2_Text, Me.Generator, Me.Label2, Me.ActivationKey, Me.Label1, Me.Algorithms1_Text})
...
#End Region
    ...
    Private Sub Generator_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Generator.Click
        ...
        If Not (CInt(Me.Algorithms1_Text.Text) >= 1000 And CInt(Me.Algorithms1_Text.Text) <= 7000) Then
